...
describe('Cypress migrations', () => {
  ...
  describe('Cypress 16 migrations', () => {
    ...
    // The Vite check moved out of the package update gate and into the
    // migration, which resolves Vite per component testing project, so a
    // hoisted transitive Vite no longer holds the bump.
